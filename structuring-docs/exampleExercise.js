...
db.blogpost.insertMany([
  {
    ...
    body:
      "The world has ended, I repeat the world has ended, but wait, how am I writing a blog if the world has ended",
    created: new Date(),
  ...
  },
  {
    ...
    body:
      "What do you think the original sin is anyway?, I have no idea, something to do with a bush woman eating somekind of fruit, not sure what fruit it was",
    created: new Date(),
    blogger: ObjectId("5d2189afc062f7de40dddb99")
  },
  {
    title: "Chick Flicks",
    body:
      "For an adult, I sure do love watching chick flicks when I get the time to do just that",
    created: new Date(),
